...
def test_nextcollatz_2_returns1():
    expected = 1
    assert problem14.next_collatz(2) == expected


def test_nextcollatz_3_returns10():
    expected = 10
    assert problem14.next_collatz(3) == expected


def test_nextcollatz_4_returns2():
    expected = 2
    assert problem14.next_collatz(4) == expected


def test_nextcollatz_5_returns16():
    expected = 16
    assert problem14.next_collatz(5) == expected
